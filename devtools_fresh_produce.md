# DevTools — Part 1 of 2: fresh_produce + API Key
#
...
#
# How to use:
#   Copy each block into the console and click ▶️ Run (or Ctrl+Enter)
#   Follow the order: Step 1 → 2 → 3 → 4 → 5
# ─────────────────────────────────────────────────────────────────────
...
#
# ⚠️ Replace YOUR_JINA_API_KEY with your key (starts with "jina_...")
...
# ══════════════════════════════════════════════════════════════════════
# STEP 2 — Create the index with mapping
# ══════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════
# STEP 5 — Create read-only API Key for OpenClaw
# ══════════════════════════════════════════════════════════════════════
# This key allows:
#   ✅ Read and search ALL indices (for free exploration in OpenClaw)
#   ✅ View index metadata (mappings, settings)
#   ✅ Monitor the cluster (health, stats)
#
# Does NOT allow:
#   ❌ Write or delete documents
...
#   "encoded":  "YYYYYYYYYYYYYYY"   ← use this in OpenClaw (.env file)
# }
#
# ⚠️ Save the "encoded" value now — it cannot be retrieved later.
# ──────────────────────────────────────────────────────────────────────
